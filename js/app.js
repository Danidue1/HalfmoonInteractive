...
var alpacaData, llamaData;
$.when(
// make requests for data
$.getJSON('https://danidue1.carto.com/api/v2/sql?format=GeoJSON&q=SELECT * FROM us_alpacainventory', function(data) {
  alpacaData = data;
}),
$.getJSON('https://danidue1.carto.com/api/v2/sql?format=GeoJSON&q=SELECT * FROM us_llamainventory_point', function(data) {
  llamaData = data;
})
).then(function() {
...
var alpacaLayer = L.geoJson(data, {
  ...
  onEachFeature: function(feature, layer) {
    ...
    var popup = '<b>' + layer.feature.properties.atlas_name + ' </b><br />' + "Alpaca Populous: " +
